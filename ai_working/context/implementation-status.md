...
- **FR-8.7**: Longitudinal Waterline Tracking — GDPval benchmark ingested (220 tasks, 10,453 rubric items); model evaluation scores (gdpval_evaluations) not yet collected
...
- GDPval evaluations not yet collected — gdpval_evaluations table is empty; model-era scoring pipeline for FR-8.7 waterline tracking not yet built
