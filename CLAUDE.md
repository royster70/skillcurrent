...
| gdpval_evaluations | 0 ⚠ | Claude API eval — LOST in 2026-07 laptop rebuild (was 225). Restore via 2 Sonnet eras, ~$15.70 (Haiku judge already the floor); pending account recharge |
